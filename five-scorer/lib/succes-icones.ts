// Les icônes des succès et les teintes de leurs médailles.
//
// Un seul jeu, au trait : grille de 24, trait de 2, bouts et angles ronds —
// le dessin de la barre du bas et du menu, pas celui du jeu maison
// (components/Icon.tsx, bouts francs), parce qu'une médaille est un objet
// rond et que des angles vifs y griffent. Chaque icône est dessinée pour se
// lire à 20 px, la taille qu'elle a au cœur d'une médaille de 40 : pas de
// détail sous deux unités, pas plus de trois idées par dessin.
//
// La table est RECOPIÉE telle quelle dans five-scorer-mobile/lib/succes-icones.ts
// (l'app ne peut pas importer le site). Le jour où un dessin change, il change
// des deux côtés dans le même commit, sinon un joueur voit deux médailles
// différentes pour le même succès selon l'écran.
