...
import { adresseDejaPrise, ESSAIS_DE_SLUG } from "@/lib/creation-club";
...
export default function CreateClubForm() {
  ...
  async function onSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    for (let n = 1; n <= ESSAIS_DE_SLUG; n++) {
      ...
      // Cette lecture cherchait le mot « slug », que la création d'organisation
      // n'écrit PAS (elle lève « Organization already exists »). La reprise
      // suffixée ci-dessus n'avait donc jamais servi : le deuxième club à
      // choisir un nom déjà pris se voyait refuser, en anglais. Voir
      // `lib/creation-club.ts`, où la règle vit désormais seule.
      if (!adresseDejaPrise(res.error)) {
